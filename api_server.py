...
def map_graphics_handoff_ledger_row(row: dict) -> dict:
    ...
    return {
        ...
        "repairRequestId": row.get("repairRequestId") or source_payload.get("repairRequestId") or pig_payload.get("repairRequestId") or "",
        "sourceFlagId": row.get("sourceFlagId") or source_payload.get("sourceFlagId") or pig_payload.get("sourceFlagId") or "",
        "originalContentId": row.get("originalContentId") or source_payload.get("originalContentId") or pig_payload.get("originalContentId") or "",
        "originalDocId": row.get("originalDocId") or source_payload.get("originalDocId") or pig_payload.get("originalDocId") or "",
        "originalCollection": row.get("originalCollection") or source_payload.get("originalCollection") or pig_payload.get("originalCollection") or "",
        "originalAssetLink": row.get("originalAssetLink") or source_payload.get("originalAssetLink") or row.get("previousAssetUrl") or "",
        "issueReason": row.get("issueReason") or source_payload.get("issueReason") or row.get("reworkReason") or qc_payload.get("reworkReason") or "",
        "repairInstructions": row.get("repairInstructions") or source_payload.get("repairInstructions") or row.get("requestedChanges") or qc_payload.get("requestedChanges") or "",
