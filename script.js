...
const templateDefinitions = {
  ...
  "short-form-left": {
    ...
    values: {
      ...
      secondaryAttributionLetterSpacing: "1.2",
      secondaryAttributionX: "7.4",
      secondaryAttributionY: "56.1",
  ...
  "short-form-center": {
    ...
    values: {
      ...
      secondaryAttributionLetterSpacing: "0.8",
      secondaryAttributionX: "50",
      secondaryAttributionY: "50.9",
      secondaryAttributionColor: "#f6f4ef",
      emphasisTextEnabled: "off",
    },
  },
...
function drawShortFormContestBadge(width, height) {
  const template = controls.templatePreset.value;
  const verticalScale = template.endsWith("-square") ? 1 : Math.min(1, width / height);
  const specs = {
    left: { x: 0.78, y: 0.805 * verticalScale, w: 0.27 },
    center: { x: 0.5, y: 0.8 * verticalScale, w: 0.27 },
    right: { x: 0.24, y: 0.805 * verticalScale, w: 0.27 },
  };
